...
namespace DI_Service_Lifetime.Controllers
{
    ...
    ITransientGuidService transient2) : Controller
    {
        private readonly IScopedGuidService _scoped1 = scoped1;
        private readonly IScopedGuidService _scoped2 = scoped2;

        private readonly ISingletonGuidService _singleton1 = singleton1;
        private readonly ISingletonGuidService _singleton2 = singleton2;

        private readonly ITransientGuidService _transient1 = transient1;
        private readonly ITransientGuidService _transient2 = transient2;
